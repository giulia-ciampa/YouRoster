...
public class EmailTemplateBuilder {
    ...
    public static String buildAccountRejectionEmail(String name) {
        return """
                <!DOCTYPE html>
                         <html lang="it">
                         <head>
                         ...
                         <td style="padding-top: 25px; color: #33007A; font-size: 15px; line-height: 1.6;">
                         <h2 style="margin-top: 0; color: #252218; font-size: 15px;">Account disabilitato.</h2>
                         <p style="color: #252218;">Gentile utente,</p>
                         <p style="color: #252218;">La richiesta di registrazione con l'email <strong>%s</strong> a YouRost è stata rifiutata. Può contattarci telefonicamente.</p>
                         </td>
                         </tr>
